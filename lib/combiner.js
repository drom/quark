...
// branch(0) loadstore(1) alu(2) drop-fear(3) lit_slot(4) PS-change(5) RS-change(6)
var words = [
    {name:'LIT4',        use:[0, 0, 0, 1, 1,   1, 0, -1, 0]}, // (          -- x )
...
function good_lit_slot (arr) {
    var i, count = 0;
    for (i = 0; i < arr.length; i++) {
        count += words[arr[i]].use[4]; // LIT slots
    }
